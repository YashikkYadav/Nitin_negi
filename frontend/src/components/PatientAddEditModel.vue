            ...
            <v-card-text class="popup-detail">
                <v-form ref="form" v-model="isValid">
                    ...
                    <v-row>
                        ...
                        <v-col cols="6">
                            <!-- Category -->
                            <v-select v-model="form.tags" :items="['New', 'Followup']" label="Category"
                                :rules="[rules.required]" variant="outlined" dense>
                            </v-select>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-col cols="6">
                            <!-- Referred By -->
                            <v-text-field v-model="form.referredBy" label="Referred By (Optional)"
                    ...
                    <v-expand-transition>
                        <div v-if="moreOptions">
                            <v-row>
                                ...
                                <v-col cols="12" sm="6">
                                    <v-text-field v-model="form.paymentCategory" label="Payment Category" placeholder="e.g. Cash, Insurance, Credit"
                                        variant="outlined" dense>
                                    </v-text-field>
                                </v-col>
                            </v-row>
    ...
    data() {
        return {
            ...
            form: {
                ...
                bloodGroup: "",
                allergies: "",
                tags: "New", // Set default category to "New"
                referredBy: "",
                paymentCategory: "", // Add payment category field
            },
            rules: {
    ...
    methods: {
        async fetchPatientDetails() {
            ...
            if (res) {
                this.form = {
                    ...
                    spouseName: res.patient.spouseName,
                    ...
                    paymentCategory: res.patient.paymentCategory || "", // Add payment category
                };
            }
        },
        async submitForm() {
            ...
            const requestData = {
                ...
                paymentCategory: this.form.paymentCategory, // Add payment category to request
            };
        ...
        resetForm() {
            this.form = {
                ...
                tags: "",
                referredBy: "",
                paymentCategory: "", // Reset payment category
            };
        }
    },
};
