    ...
    <v-container class="prescription-page" style="max-width: 100%;">
      <div class="profile">
        <v-card class="section-card">
          ...
          <v-row>
            <v-col cols="12" sm="12">
              <v-file-upload clearable density="compact" variant="compact" title="Drag and drop profile image"
                show-size></v-file-upload>
            </v-col>
          </v-row>
        </v-card>
        <v-card class="section-card">
          ...
          <v-row class="about-item">
            <v-col cols="12" sm="4">
              <div class="date-container">
                <a-date-picker v-model:value="form.from" :format="dateFormatList" valueFormat="YYYY-MM-DD" placeholder="DD/MM/YYYY" class="mb-4"></a-date-picker>
                <div class="date-label"><label>From date</label></div>
              </div>
            </v-col>
            <v-col cols="12" sm="4">
              <div class="date-container">
                <a-date-picker v-model:value="form.to" :format="dateFormatList" valueFormat="YYYY-MM-DD" placeholder="DD/MM/YYYY" class="mb-4">
                </a-date-picker>
                <div class="date-label"><label>To date</label></div>
              </div>
            </v-col>
          </v-row>
        </v-card>
  ...
  methods: {
    async fetchProfileData() {
      ...
      if (res.doctorProfile !== null) {
        ...
        this.form.from = res.doctorProfile.unavailabilityDate.from.split("T")[0]
