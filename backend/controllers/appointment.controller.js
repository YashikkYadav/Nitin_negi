...
const getAllUpcomingAppointments = async (req, res) => {
  try {
    ...
    const appointments = await appointmentService.getAllUpcomingAppointments(doctorId, page, limit);
    if (appointments?.error) {
      return res
        .status(appointments.statusCode)
        .send(appointments.error);
...
const getAllPastAppointments = async (req, res) => {
  try {
    ...
    const appointments = await appointmentService.getAllPastAppointments(doctorId, page, limit);
    if (appointments?.error) {
      return res
        .status(appointments.statusCode)
        .send(appointments.error);
...
const getAppointmentsByDateRange = async (req, res) => {
  try {
    ...
    const appointments = await appointmentService.getAppointmentsByDateRange(doctorId, from, to, page, limit);
    if (appointments?.error) {
      return res
        .status(appointments.statusCode)
        .send(appointments.error);
