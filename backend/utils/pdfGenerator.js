...
const generatePrescriptionPDF = async (prescription, patientData) => {
  return new Promise((resolve, reject) => {
    ...
    // Add patient information line at the end of prescription
    // const endText = `${patientData?.uid}: ${patientData?.fullName} (${patientData?.age || 'N/A'}y, ${patientData?.gender || 'N/A'}) - ${patientData?.phoneNumber || 'N/A'} | Date & Time: ${new Intl.DateTimeFormat('en-US', {
    //   year: 'numeric',
    //   month: 'short',
    //   day: 'numeric',
    //   hour: '2-digit',
